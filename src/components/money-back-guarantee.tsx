...
function MoneyBackGuarantee() {
	return (
		<section className="flex flex-col md:flex-row items-center justify-center gap-2 md:gap-8 bg-teal-100 px-4 py-10 md:p-6 rounded-xl">
			<Image
			...
			<div className="flex flex-col gap-4 md:w-6/12">
				<h1 className="font-heading text-center md:text-left font-semibold text-2xl md:text-4xl">
